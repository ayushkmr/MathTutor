  ...
  return (
    <>
      ...
      <div className="py-5 px-4 flex flex-col gap-3 md:w-unit-9xl md:mx-auto md:gap-5 lg:w-[892px] lg:gap-8">
        <h1 className="text-2xl font-medium">Terms of Service for XScope</h1>
        <p>
        ...
        <p>
          Welcome to XScope. These terms and conditions outline the rules and
          regulations for the use of XScope&apos;s website and services. By
          ...
          XScope&apos;s website and services if you do not accept all of the
          terms and conditions stated on this page.
        </p>

        <h2 className="text-xl font-medium">License</h2>
        <p>
          Unless otherwise stated, XScope owns the intellectual property rights
          for all material on XScope. All intellectual property rights are
          reserved. You may access this from XScope for your own personal use
        ...
        <ul>
          ...
          <li>
            ...
            the interfaces provided by XScope.
          </li>
        </ul>

        <h2 className="text-xl font-medium">Indemnification</h2>
        <p>
          You agree to indemnify, defend and hold harmless XScope, its officers,
        ...
        <p>
          XScope reserves the right to terminate your access to the site and the
