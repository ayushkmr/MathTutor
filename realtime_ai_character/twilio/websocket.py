...
GREETING_TXT_MAP = {
    "en-US": "Hello! I'm your Math Tutor. How can I assist you with math today?",
    "es-ES": "¡Hola! Soy tu tutor de matemáticas. ¿Cómo puedo ayudarte con las matemáticas hoy?",
    "fr-FR": "Bonjour! Je suis votre tuteur de mathématiques. Comment puis-je vous aider avec les mathématiques aujourd'hui?",
    "de-DE": "Hallo! Ich bin dein Mathematik-Tutor. Wie kann ich dir heute bei Mathematik helfen?",
    "it-IT": "Ciao! Sono il tuo tutor di matematica. Come posso aiutarti con la matematica oggi?",
    "pt-PT": "Olá! Sou o seu tutor de matemática. Como posso ajudá-lo com matemática hoje?",
    "hi-IN": "नमस्ते! मैं आपका गणित ट्यूटर हूँ। आज मैं गणित में आपकी कैसे मदद कर सकता हूँ?",
    "pl-PL": "Cześć! Jestem twoim korepetytorem matematyki. Jak mogę ci dzisiaj pomóc w matematyce?",
    "zh-CN": "你好！我是你的数学导师。今天我能帮你解决什么数学问题？",
    "ja-JP": "こんにちは！私はあなたの数学の家庭教師です。今日はどのように数学をお手伝いできますか？",
    "ko-KR": "안녕하세요! 저는 당신의 수학 교사입니다. 오늘 수학 공부를 어떻게 도와드릴까요?",
}
