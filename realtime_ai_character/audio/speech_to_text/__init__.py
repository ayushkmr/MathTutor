...
def get_speech_to_text() -> SpeechToText:
    use = os.getenv("SPEECH_TO_TEXT_USE", "OPENAI_STT")
    if use == "GOOGLE":
        ...
        from realtime_ai_character.audio.speech_to_text.openai_stt import OpenAI_STT
        OpenAI_STT.initialize()
        return OpenAI_STT.get_instance()
